  ...
  return (
    <>
      <div className="about-us">
        ...
        <p className="parr1">
          ¿Cómo funciona? Es sencillo. Los donantes pueden registrarse en
          nuestra plataforma, especificar los alimentos que desean donar y
          cuándo están disponibles. Los voluntarios también son bienvenidos para
          ofrecer su tiempo y habilidades en la distribución de alimentos o en
          otras actividades de apoyo.
        </p>
        <p className="parr1">
          Por otro lado, las organizaciones benéficas y las personas que
          necesitan alimentos pueden registrarse para recibir donaciones.
          Nuestra plataforma hace que sea fácil encontrar alimentos frescos y
          nutritivos para aquellos que más lo necesitan, ayudando a aliviar las
          preocupaciones sobre la seguridad alimentaria y promoviendo el
        ...
        <p className="parr1">
          ...
          también el alma, extendiendo una mano amiga a quienes atraviesan
          tiempos difíciles.
        </p>
        <p className="parr1">
