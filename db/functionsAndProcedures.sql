...
BEGIN
    ...
    SELECT CONCAT_WS(' ',apellido_mat, apellido_pat,nombre  ) INTO nomCom
    FROM voluntario
...
BEGIN
    ...
    SELECT coalesce(COUNT(*), 0) INTO xnum
    FROM donacion d
    INNER JOIN alimento a ON d.idalimento = a.idalimento AND a.idgeneral = xidonador
